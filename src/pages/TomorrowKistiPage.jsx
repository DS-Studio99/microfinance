...
import {
  ...
  MdExpandMore, MdExpandLess, MdRefresh, MdChevronRight, MdEvent, MdCheckCircle, MdVerified
} from 'react-icons/md'
...
const KistiMemberRow = ({ member }) => {
  ...
  const isTomorrowExpected = member.expected_payment_date === tomorrow
  const isTomorrowRegular = member.loan_payment_date === tomorrow
  ...
  return (
      <div style={{
        ...
        background: isTomorrowExpected ? '#f0fdf4' : (days >= 30 ? '#fff9f9' : '#fff'),
        alignItems: 'center',
      }}>
        <div>
        ...
        {/* Days overdue badge */}
        {days && sev && !isTomorrowRegular && !isTomorrowExpected && (
        <div style={{
      ...
      {isTomorrowExpected && (
         <div style={{ background: '#22c55e', color: '#fff', borderRadius: 10, padding: '5px 10px', textAlign: 'center', flexShrink: 0, minWidth: 64 }}>
           ...
           <div style={{ fontSize: 9, fontWeight: 700, marginTop: 1, fontFamily: "'Hind Siliguri', sans-serif" }}>কাল</div>
         </div>
      )}
      {isTomorrowRegular && (
         <div style={{ background: '#84cc16', color: '#fff', borderRadius: 10, padding: '5px 10px', textAlign: 'center', flexShrink: 0, minWidth: 64 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 4 }}>
          <div style={{ background: 'rgba(255,255,255,0.25)', borderRadius: 20, padding: '3px 10px', display: 'flex', alignItems: 'center', gap: 5 }}>
            <MdEvent style={{ color: '#fff', fontSize: 13 }} />
      ...
      <div className="page-enter">
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: '1.25rem', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1 }}>
            <h1 style={{ fontSize: 22, fontWeight: 800, color: '#0f172a', fontFamily: "'Hind Siliguri', sans-serif" }}>
              আগামীকালের কিস্তি সংগ্রহ
            </h1>
            <p style={{ fontSize: 13, color: '#64748b', fontFamily: "'Hind Siliguri', sans-serif", marginTop: 2 }}>
              আগামীকালের নির্ধারিত, সম্ভাব্য এবং সকল বকেয়া কিস্তির তালিকা
            </p>
          </div>
          <button
        ...
        {!loading && kistiMembers.length === 0 && (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '5rem 1rem', textAlign: 'center' }}>
            <div style={{ width: 80, height: 80, borderRadius: '50%', background: 'linear-gradient(135deg,#ecfccb,#d9f99d)', border: '2px solid #bef264', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
              <MdEvent style={{ fontSize: 38, color: '#65a30d' }} />
            </div>
            <h3 style={{ fontSize: 20, fontWeight: 800, color: '#3f6212', fontFamily: "'Hind Siliguri', sans-serif", marginBottom: 8 }}>
              আগামীকাল কোনো সদস্যের কিস্তি নেই! 🎉
            </h3>
            <p style={{ fontSize: 14, color: '#64748b', fontFamily: "'Hind Siliguri', sans-serif" }}>
              আগামীকালকের দিনটি আপনার জন্য ফাঁকা।
            </p>
          </div>
        )}
        ...
        {!loading && byVO.length > 0 && (
          <>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
              <MdGroups style={{ color: '#65a30d', fontSize: 18 }} />
...
export default TomorrowKistiPage
